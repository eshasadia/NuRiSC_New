...
def main(input_loc, output_loc):
    ...
    if (input_loc):
        ...
        data_path = 'C:/Users/es255022/OneDrive - Teradata/Desktop/Dataset/MoNuSAC'  # Path to read data from
    if (output_loc):
        destination_path = output_loc  # Path to save n-ary masks corresponding to xml files
    else:
        destination_path = 'C:/Users/es255022/OneDrive - Teradata/Desktop/Dataset/MoNuSAC/out'
    ...
    for patient_loc in patients:
        ...
        for sub_image_loc in sub_images:
            ...
            cv2.imwrite(destination_path + '/MoNuSAC_processed/Images' + sub_image_name + '.png',
            ...
            n_ary_mask = np.transpose(np.zeros((img((0, 0), 0, img.level_dimensions[0]).size)))
                ...
                for child in root[k]:
                    for x in child:
                        ...
                        if r == 'Region':
                            ...
                            sio.savemat(destination_path + '/MoNuSAC_processed/Labels' + sub_image_name + ".mat",
                                        {'inst_map': n_ary_mask, 'class_map': type_map})
