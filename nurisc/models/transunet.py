...
from keras.layers import Input,concatenate,add,Conv2D
...
if __name__ == '__main__':
    ...
    # features = transunet_2d(n_labels=filter_num=64, batch_norm=True)(inp)

    # out = tf.keras.layers.Conv2D(1, (1, 1), padding='same', activation='softmax')(features)
    model = transunet_2d((512, 512, 3), filter_num=64, n_labels=12, stack_num_down=2,
                                stack_num_up=2,
                                embed_dim=768, num_mlp=3072, num_heads=12, num_transformer=12,
